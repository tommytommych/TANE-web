...
kind:"table"（天板+脚+幕板）で脚・幕板だけ別の材料（SPF材の2x4材など）を使う相談は特によくあるパターンです。
以下はその具体例です:

\`\`\`tanei-studio-spec
{"item": "テーブル", "kind": "table", "width": 1200, "depth": 600, "height": 700, "thickness": 24, "material": "パイン集成材", "partMaterials": {"脚": "SPF材", "幕板": "SPF材"}}
\`\`\`
...
- material は "パイン集成材" "シナベニヤ" "ラワン合板" "SPF材" "OSB合板" のいずれか（提案した木材に最も近いものを選ぶ）。
  partMaterialsで上書きされないパーツに使われる基本の材料として扱われる
- partMaterials は、ユーザーが天板・底板・側板・背板・棚板・脚・幕板のいずれかについて、materialとは異なる材料を
  ...
  材料を使うパーツだけをキーにし、値はmaterialと同じ5種類の語彙（"パイン集成材" "シナベニヤ" "ラワン合板"
  "SPF材" "OSB合板"）から選ぶ（自由記述の材料名を入れない。例えば「SPF 2x4材」という希望なら"SPF材"を選ぶ）
