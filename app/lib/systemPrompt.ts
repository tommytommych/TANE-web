...
- material は "パイン集成材" "シナベニヤ" "ラワン合板" "SPF材" "OSB合板" のいずれか（提案した木材に最も近いものを選ぶ）。
  パーツによらず家具全体で使う基本の材料として扱われる
- partMaterials は任意。ユーザーが「天板はパイン集成材、脚と幕板はSPF材にしたい」のように、パーツによって異なる
  材料を希望した場合のみ指定する。"天板"・"底板"・"側板"・"背板"・"棚板"・"脚"・"幕板"のうち、実際にmaterialと
  異なる材料を使うパーツだけをキーにし、値はmaterialと同じ5種類の語彙（"パイン集成材" "シナベニヤ" "ラワン合板"
  "SPF材" "OSB合板"）から選ぶ（自由記述の材料名を入れない。例えば「SPF 2x4材」という希望なら"SPF材"を選ぶ）。
  全パーツが同じ材料であれば、partMaterials自体を省略する（無理にすべてのキーを埋めない）
